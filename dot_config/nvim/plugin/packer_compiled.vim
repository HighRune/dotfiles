...
_G.packer_plugins = {
  ["barbar.nvim"] = {
    loaded = true,
    path = "/home/charles/.local/share/nvim/site/pack/packer/start/barbar.nvim"
  },
  ["galaxyline.nvim"] = {
    config = { "require('config.galaxyline').post()" },
    loaded = true,
    path = "/home/charles/.local/share/nvim/site/pack/packer/start/galaxyline.nvim"
  },
  ["gitsigns.nvim"] = {
  ...
  ["nvim-compe"] = {
    loaded = true,
    path = "/home/charles/.local/share/nvim/site/pack/packer/start/nvim-compe"
  },
  ["nvim-lspconfig"] = {
    loaded = true,
  ...
  ["nvim-lspinstall"] = {
    loaded = true,
    path = "/home/charles/.local/share/nvim/site/pack/packer/start/nvim-lspinstall"
  },
  ["nvim-treesitter"] = {
    loaded = true,
  ...
  snap = {
    loaded = true,
    path = "/home/charles/.local/share/nvim/site/pack/packer/start/snap"
  }
}
