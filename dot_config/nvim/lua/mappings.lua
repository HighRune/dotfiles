...
local function submode()
	...
	fn["submode#map"]("newline", "n", "s", "O", ":set paste<CR>m`O<Esc>``:set nopaste<CR>")
	fn["submode#enter_with"]("ge", "nxo", "", "ge", "<Plug>WordMotion_gE")
	fn["submode#leave_with"]("ge", "nxo", "", "g")
	fn["submode#map"]("ge", "nxo", "", "e", "<Plug>WordMotion_gE")
	map({ "n", "o", "x" }, "s", "<Plug>(textobj-specialcharacter)")
	-- fn["submode#map"]("ge", "nxo", "", "N", "e")
	-- fn["submode#leave_with"]("ge", "nxo", "", "<Esc>")
