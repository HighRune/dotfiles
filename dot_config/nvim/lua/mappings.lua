...
local function bufferline()
  ...
  map("n", "<a-1>", ":BufferLineGoToBuffer 1<cr>", silent)
  map("n", "<a-2>", ":BufferLineGoToBuffer 2<cr>", silent)
  map("n", "<a-3>", ":BufferLineGoToBuffer 3<cr>", silent)
  map("n", "<a-4>", ":BufferLineGoToBuffer 4<cr>", silent)
  map("n", "<a-5>", ":BufferLineGoToBuffer 5<cr>", silent)
  map("n", "<a-6>", ":BufferLineGoToBuffer 6<cr>", silent)
  map("n", "<a-7>", ":BufferLineGoToBuffer 7<cr>", silent)
  map("n", "<a-8>", ":BufferLineGoToBuffer 8<cr>", silent)
  map("n", "<a-9>", ":BufferLineGoToBuffer -1<cr>", silent)
end
