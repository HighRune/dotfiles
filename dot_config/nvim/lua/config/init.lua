...
local function colorizer() require("setup").colorizer() end

-------------------- ahmedkhalf/project.nvim
local function project() require("setup").project() end

-------------------- nacro90/numb.nvim
local function numb() require("setup").numb() end

-------------------- folke/tokyonight.nvim
local function tokyonight() require("options").tokyonight() end

-------------------- jeetsukumaran/vim-indentwise
local function indentwise() require("mappings").indentwise() end
...
local function gitsigns() require("setup").gitsigns() end
...
-------------------- gbprod/cutlass.nvim
local function cutlass() require("setup").cutlass() end
...
local function comment() require("setup").comment() end
...
local function dial()
    ...
    require("dial.config").augends:register_group({
        default = {
            augend.integer.alias.decimal, augend.integer.alias.decimal_int,
            augend.date.alias["%Y/%m/%d"], augend.semver.alias.semver,
            augend.constant.alias.bool, augend.constant.new({
                elements = {"let", "const"}
            }), augend.constant.new({
                elements = {"&&", "||"},
                word = false,
...
local function highlightedyank() require("options").highlightedyank() end
...
-------------------- kana/vim-arpeggio
local function arpeggio() require("mappings").arpeggio() end
