...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[3] = LAYOUT_split_3x5_2(KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_PMNS, KC_9, KC_8, KC_7, KC_PSLS, OSM(MOD_RALT), OSM(MOD_RGUI), OSM(MOD_RSFT), OSM(MOD_RCTL), KC_NO, KC_PPLS, KC_3, KC_2, KC_1, KC_0, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_PEQL, KC_6, KC_5, KC_4, KC_PAST, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS)
};
