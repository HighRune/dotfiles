...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[1] = LAYOUT_split_3x5_2(KC_GRV, KC_MINS, KC_EQL, KC_PLUS, KC_AT, KC_AMPR, KC_LBRC, KC_RBRC, KC_SLSH, KC_BSLS, KC_EXLM, KC_QUES, KC_HASH, KC_ASTR, KC_PERC, KC_TILD, KC_LPRN, KC_RPRN, KC_CIRC, KC_DLR, KC_NO, KC_NO, KC_UNDS, KC_PIPE, KC_NO, KC_NO, KC_LCBR, KC_RCBR, KC_NO, KC_NO, KC_TRNS, KC_TRNS, LT(3,KC_ENT), KC_TRNS),
	[2] = LAYOUT_split_3x5_2(KC_HOME, KC_END, KC_PGDN, KC_PGUP, KC_CAPS, KC_MUTE, KC_MPRV, KC_MPLY, KC_MNXT, KC_NO, KC_LEFT, KC_RGHT, KC_DOWN, KC_UP, KC_DEL, KC_VOLU, KC_RCTL, KC_RSFT, KC_RGUI, KC_RALT, KC_WH_L, KC_WH_R, KC_WH_D, KC_WH_U, KC_INS, KC_VOLD, KC_BRIU, KC_BRID, KC_NO, KC_NO, KC_BSPC, LT(3,KC_TAB), KC_TRNS, KC_TRNS),
