...
const uint16_t PROGMEM l2ctl[] = { LT(1,KC_SPC), KC_H, COMBO_END};
const uint16_t PROGMEM l2sft[] = { LT(1,KC_SPC), KC_T, COMBO_END};
const uint16_t PROGMEM l2gui[] = { LT(1,KC_SPC), KC_N, COMBO_END};
const uint16_t PROGMEM l2alt[] = { LT(1,KC_SPC), KC_S, COMBO_END};
const uint16_t PROGMEM l1cs[] = { LT(2,KC_TAB), KC_E, KC_U, COMBO_END};
const uint16_t PROGMEM l1gs[] = { LT(2,KC_TAB), KC_E, KC_O, COMBO_END};
const uint16_t PROGMEM l2cs[] = { LT(1,KC_SPC), KC_T, KC_H, COMBO_END};
const uint16_t PROGMEM l2gs[] = { LT(1,KC_SPC), KC_T, KC_N, COMBO_END};
