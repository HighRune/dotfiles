...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[1] = LAYOUT_split_3x5_2(KC_GRV, KC_MINS, KC_EQL, KC_PLUS, KC_PERC, KC_BSLS, KC_LBRC, KC_RBRC, KC_PIPE, KC_AMPR, KC_EXLM, KC_QUES, KC_HASH, KC_ASTR, KC_TILD, KC_SLSH, KC_LPRN, KC_RPRN, KC_LCBR, KC_RCBR, KC_NO, KC_NO, KC_CIRC, KC_DLR, KC_NO, KC_AT, KC_LT, KC_GT, KC_UNDS, KC_NO, KC_TRNS, KC_TRNS, KC_TRNS, KC_ENT),
