...
// const uint16_t PROGMEM l3c[] = { OSL(3), KC_U, COMBO_END};
// const uint16_t PROGMEM l3g[] = { OSL(3), OSM(MOD_LGUI), COMBO_END};
...
combo_t key_combos[COMBO_COUNT] = {
  ...
  // [L3C] = COMBO(l3c, OSL(3)|OSM(MOD_LCTL)),
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT_split_3x5_2(KC_QUOT, KC_COMM, KC_DOT, KC_P, KC_Y, KC_F, KC_G, KC_C, KC_R, KC_L, KC_A, KC_O, KC_E, KC_U, KC_I, KC_D, KC_H, KC_T, KC_N, KC_S, KC_SCLN, KC_Q, KC_J, KC_K, KC_X, KC_B, KC_M, KC_W, KC_V, KC_Z, OSL(3), OSL(2), OSL(1), LT(3,KC_SPC)),
	[1] = LAYOUT_split_3x5_2(KC_GRV, KC_EQL, KC_MINS, KC_PLUS, KC_AMPR, KC_BSLS, KC_SLSH, KC_PERC, KC_LBRC, KC_RBRC, KC_QUES, KC_EXLM, KC_CIRC, KC_DLR, KC_TILD, KC_AT, KC_HASH, KC_ASTR, KC_LPRN, KC_RPRN, KC_NO, KC_NO, KC_UNDS, KC_PIPE, KC_NO, KC_NO, KC_NO, KC_NO, KC_LCBR, KC_RCBR, KC_TRNS, KC_TRNS, TO(0), KC_TRNS),
	[2] = LAYOUT_split_3x5_2(KC_HOME, KC_END, KC_PGDN, KC_PGUP, KC_CAPS, KC_NO, KC_WH_U, KC_WH_D, KC_WH_L, KC_WH_R, KC_ESC, KC_BSPC, KC_ENT, KC_TAB, KC_DEL, KC_NO, OSM(MOD_RCTL), OSM(MOD_RSFT), OSM(MOD_RGUI), OSM(MOD_RALT), KC_LEFT, KC_RGHT, KC_DOWN, KC_UP, KC_INS, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_TRNS, TO(0), KC_TRNS, KC_TRNS),
	[3] = LAYOUT_split_3x5_2(KC_5, KC_6, KC_7, KC_8, KC_9, KC_BRIU, KC_MPRV, KC_MPLY, KC_MNXT, KC_NO, KC_1, KC_2, KC_3, KC_4, KC_0, KC_BRID, OSM(MOD_RCTL), OSM(MOD_RSFT), OSM(MOD_RGUI), OSM(MOD_RALT), KC_PAST, KC_PSLS, KC_PMNS, KC_PPLS, KC_PEQL, KC_NO, KC_VOLU, KC_VOLD, KC_MUTE, KC_NO, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS)
};
