...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[2] = LAYOUT_split_3x5_2(KC_HOME, KC_END, KC_PGDN, KC_PGUP, KC_INS, KC_VOLU, KC_MPRV, KC_MPLY, KC_MNXT, KC_NO, KC_LEFT, KC_RGHT, KC_DOWN, KC_UP, KC_CAPS, KC_VOLD, KC_RCTL, KC_RSFT, KC_RGUI, KC_RALT, KC_WH_L, KC_WH_R, KC_WH_D, KC_WH_U, KC_NO, KC_MUTE, KC_BRIU, KC_BRID, KC_NO, KC_NO, KC_DEL, KC_BSPC, KC_TRNS, KC_TRNS),
