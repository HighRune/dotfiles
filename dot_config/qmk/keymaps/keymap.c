...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[1] = LAYOUT_split_3x5_2(KC_GRV, KC_EQL, KC_MINS, KC_PLUS, KC_AMPR, KC_BSLS, KC_SLSH, KC_PERC, KC_LBRC, KC_RBRC, KC_EXLM, KC_QUES, KC_CIRC, KC_DLR, KC_TILD, KC_AT, KC_HASH, KC_ASTR, KC_LPRN, KC_RPRN, KC_NO, KC_NO, KC_UNDS, KC_PIPE, KC_NO, KC_NO, KC_NO, KC_NO, KC_LCBR, KC_RCBR, KC_TRNS, KC_TRNS, TO(0), KC_TRNS),
